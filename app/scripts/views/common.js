...
define([
    ...
    SubViewableView = TemplateView.extend({
        initialize: function () {
            this.subviews = {};
        },
    ...
    CollectionView = SubViewableView.extend({
        ...
        initialize: function (attrs) {
            ...
            SubViewableView.prototype.initialize.call(this, attrs);
        ...
        remove: function () {
            ...
            SubViewableView.prototype.remove.call(this);
        }
    });

    var views = {
        TemplateView: TemplateView,
        SubViewableView: SubViewableView,
